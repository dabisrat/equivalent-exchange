...
CREATE OR REPLACE FUNCTION "public"."decrementpoints"("card_id" "uuid") RETURNS bigint
    LANGUAGE "sql"
    AS $$
  update reward_card
  set points = points - 1
...
ALTER FUNCTION "public"."decrementpoints"("card_id" "uuid") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."incrementpoints"("card_id" "uuid") RETURNS bigint
    LANGUAGE "sql"
    AS $$
  update reward_card
  set points = points + 1
...
ALTER FUNCTION "public"."incrementpoints"("card_id" "uuid") OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."reward_card"
    ADD CONSTRAINT "reward_card_id_key" UNIQUE ("id");

ALTER TABLE ONLY "public"."reward_card"
    ADD CONSTRAINT "reward_card_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."stamp"
    ADD CONSTRAINT "stamp_id_key" UNIQUE ("id");

ALTER TABLE ONLY "public"."stamp"
    ADD CONSTRAINT "stamp_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."stamp"
    ADD CONSTRAINT "stamp_reward_card_id_key" UNIQUE ("reward_card_id");
...
ALTER TABLE ONLY "public"."stamper"
    ADD CONSTRAINT "public_stamper_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id");

ALTER TABLE ONLY "public"."stamper"
    ADD CONSTRAINT "public_stamper_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");

ALTER TABLE ONLY "public"."reward_card"
    ADD CONSTRAINT "reward_card_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id");
...
CREATE POLICY "Enable select for authenticated users only" ON "public"."stamper" FOR SELECT TO "authenticated" USING (true);

CREATE POLICY "Enable stampers to update" ON "public"."reward_card" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."stamper"
...
GRANT ALL ON FUNCTION "public"."decrementpoints"("card_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."decrementpoints"("card_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."decrementpoints"("card_id" "uuid") TO "service_role";

GRANT ALL ON FUNCTION "public"."incrementpoints"("card_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."incrementpoints"("card_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."incrementpoints"("card_id" "uuid") TO "service_role";
