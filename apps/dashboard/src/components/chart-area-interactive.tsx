...
import { useIsMobile } from "@eq-ex/ui/hooks/use-mobile";
import {
  Card,
  CardAction,
  CardContent,
...
import {
  ToggleGroup,
  ToggleGroupItem,
} from "@eq-ex/ui/components/toggle-group";
...
export function ChartAreaInteractive({
  ...
  data: { date: string; stamps: number; redemptions: number }[];
}) {
      ...
      <CardHeader>
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Stamps and Redemptions for the last 3 months
          </span>
